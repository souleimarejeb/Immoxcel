...
public class SupplierContainerController {
    ...
    public void setData(Supplier supplier){
        if (supplier != null) {
            System.out.println("i am inside supliercontainer yo S");
    ...
    public void deleteOnClickButton(ActionEvent event ) {
        try {
            int  idTransaction= Integer.parseInt(idSup.getText());
            ...
            confirmationAlert.showAndWait().ifPresent(response -> {
                if (response == ButtonType.OK) {
                    try {
                        ...
                        hbox.setVisible(false); // Hide the card
                        hbox.setManaged(false); // Make sure it's not managed by the layout
                ...
                if (response == ButtonType.OK) {
                    try {
                        ...
                        if (supplier != null) {
                            ...
                            System.out.println("id transaction before YOOOOOOOOOO "+idSupplier);
